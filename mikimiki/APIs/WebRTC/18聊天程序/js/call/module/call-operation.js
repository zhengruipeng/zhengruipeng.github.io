...
import {MessagePackage} from "../../environment/model/MessagePackage.js";
import {ConstantObserver} from "../../libs/ConstantObserver/ConstantObserver.js";
import {ObserverCallBackType} from "../../libs/ConstantObserver/ObserverCallBackType.js";
...
document.addEventListener("DOMContentLoaded", function () {
    ...
    callingState.addEventListener(ObserverCallBackType.change, function () {
        ...
        if (this.value === CallingState.CALLING) {
            CallEnvironment.callTimer.start();
        } else if(
            ...
            CallEnvironment.callTimer.reset();
            CallEnvironment.callTimer.stop();
        }
    })
})
