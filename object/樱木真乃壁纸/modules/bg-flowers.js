document.addEventListener("DOMContentLoaded", function () {
    ...
    let startPageFlowerAnime = class extends startPageFlowerPartical {
        ...
        constructor() {
            ...
            this.flowerContainer.style.width = 18 - 10 * Math.sin(this.beginPoint * Math.PI / this.maxWidth) + "px";
            this.flowerContainer.style.height = 18 - 10 * Math.sin(this.beginPoint * Math.PI / this.maxWidth) + "px";
            this.flowerContainer.style.opacity = "1";
    ...
    let createRandomAnime = function () {
        ...
        let nextStage = Math.floor(Math.random() * 400);
