...
var goods_api_js_1 = require("../../../api/goods-api.js");
// 导出当前模块的对象
exports["default"] = {
    ...
    actions: {
        ...
        getListForPage: function (_a, data) {
            ...
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        case 0: return [4 /*yield*/, goods_api_js_1.GoodsApi.listPage(data)];
                        case 1:
                            res = _b.sent();
        ...
        deleteById: function (_a, id) {
            ...
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        case 0: return [4 /*yield*/, goods_api_js_1.GoodsApi.deleteId(id)];
        ...
        insert: function (_, data) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, goods_api_js_1.GoodsApi.insert(data)];
        ...
        update: function (_a, addForm) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        case 0: return [4 /*yield*/, goods_api_js_1.GoodsApi.update(addForm)];
                        case 1: return [2 /*return*/, _b.sent()];
                    }
                });
            });
        ...
        findId: function (_a, id) {
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        case 0: return [4 /*yield*/, goods_api_js_1.GoodsApi.findId(id)];
                        case 1:
                            res = _b.sent();
                            if (res.data.code === 200) {
        ...
        onSale: function (_a, id, isOnSale) {
            return __awaiter(this, void 0, void 0, function () {
                var res;
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        case 0: return [4 /*yield*/, goods_api_js_1.GoodsApi.onSale(id, isOnSale)];
                        case 1:
                            res = _b.sent();
                            if (res.data.code === 200) {
                                return [2 /*return*/, res.data.data];
