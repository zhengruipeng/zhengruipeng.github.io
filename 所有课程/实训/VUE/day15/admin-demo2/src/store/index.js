...
import GoodsModel from "../views/test/goods/goods-model.js";
import CardModel from "../views/test/card/card-model.js";
import NewsModel from "../views/test/news/news-model.js";
import UserTestModel from '../views/test/user-test/user-test-model.js';
import ShopUserModel from '../views/test/shop-user/shop-user-model.js'
