...
var card_api_js_1 = require("../../../api/card-api.js");
// 导入role-api中定义的调用接口的方法
var card_type_api_js_1 = require("../../../api/card-type-api.js");
// 导出当前模块的对象
exports["default"] = {
    ...
    actions: {
        getAllCardTypeList: function () {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, card_type_api_js_1.getGoodsTypeList()];
                        case 1: return [2 /*return*/, _a.sent()];
                    }
                });
            });
        },
        getCardTypeListAll: function () {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, card_type_api_js_1.getGoodsTypeList()];
        ...
        getListForPage: function (_a, data) {
            ...
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        case 0: return [4 /*yield*/, card_api_js_1.CardApi.listPage(data)];
                        case 1:
                            res = _b.sent();
        ...
        deleteById: function (_a, id) {
            ...
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        case 0: return [4 /*yield*/, card_api_js_1.CardApi.deleteId(id)];
        ...
        insert: function (_, data) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, card_api_js_1.CardApi.insert(data)];
                        case 1: return [2 /*return*/, _a.sent()];
                    }
                });
            });
        ...
        update: function (_a, addForm) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        case 0: return [4 /*yield*/, card_api_js_1.CardApi.update(addForm)];
                        case 1: return [2 /*return*/, _b.sent()];
                    }
                });
            });
        ...
        findId: function (_a, id) {
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        case 0: return [4 /*yield*/, card_api_js_1.CardApi.findId(id)];
                        case 1:
                            res = _b.sent();
                            if (res.data.code === 200) {
        ...
        insertMultiple: function (_, data) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, card_api_js_1.CardApi.insertMultiple(data)];
                        case 1: return [2 /*return*/, _a.sent()];
                    }
                });
            });
        },
        openCard: function (_, data) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, card_api_js_1.CardApi.openCard(data.num, data.userId)];
                        case 1: return [2 /*return*/, _a.sent()];
                    }
                });
            });
        },
        backCard: function (_, num) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, card_api_js_1.CardApi.backCard(num)];
                        case 1: return [2 /*return*/, _a.sent()];
                    }
                });
            });
        },
        findNum: function (_, num) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, card_api_js_1.CardApi.findNum(num)];
                        case 1: return [2 /*return*/, _a.sent()];
                    }
                });
            });
