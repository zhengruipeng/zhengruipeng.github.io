...
var shop_user_api_js_1 = require("../../../api/shop-user-api.js");
// 导出当前模块的对象
exports["default"] = {
    ...
    actions: {
        ...
        getListForPage: function (_a, data) {
            ...
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        case 0: return [4 /*yield*/, shop_user_api_js_1.getShopUserListForPage(data)];
                        case 1:
                            res = _b.sent();
        ...
        deleteById: function (_a, id) {
            ...
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_b) {
                    return [2 /*return*/, shop_user_api_js_1.deleteShopUserById(id)];
                });
            });
        },
        insert: function (_, data) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    return [2 /*return*/, shop_user_api_js_1.insertShopUser(data)];
                });
            });
        },
        update: function (_a, addForm) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_b) {
                    return [2 /*return*/, shop_user_api_js_1.updateShopUser(addForm)];
                });
            });
        },
        findId: function (_a, id) {
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        case 0: return [4 /*yield*/, shop_user_api_js_1.findShopUserById(id)];
                        case 1:
                            res = _b.sent();
                            if (res.data.code === 200) {
        ...
        setFreeze: function (_a, params) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_b) {
                    return [2 /*return*/, shop_user_api_js_1.setShopUserFreeze(params)];
                });
            });
        }
    }
